...
mongoose.connect("mongodb+srv://rohanadithyaanandedapu:ehTD0qhK2wZCrV77@cluster0.glffoqg.mongodb.net/?retryWrites=true&w=majority").then(() => {
...
app.get('/indexStyles.css', (req, res) => {
    res.header('Content-Type', 'text/css');
    res.sendFile(__dirname + '/views/indexStyles.css');
  });
